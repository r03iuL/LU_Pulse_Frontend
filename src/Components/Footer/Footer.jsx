  ...
  return (
    <footer className="footer py-14 px-20 bg-blue-100 text-base-content ">
      ...
      <nav>
        ...
        <a href="https://www.lus.ac.bd/" className="link link-hover">University Portal</a>
        <a href="https://www.lus.ac.bd/"className="link link-hover">About us</a>
        <a href="https://www.lus.ac.bd/"className="link link-hover">Contact</a>
        <a href="https://www.lus.ac.bd/semester-registration/"className="link link-hover">Semester Registration</a>
      </nav>
      <nav>
